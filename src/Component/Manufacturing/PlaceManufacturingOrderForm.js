...
const PlaceManufactureOrder = ({ reload,products,storeId,closeForm }) => {
    ...
    const productsOptions = products?.map((i) => {return {label:`${i.name}`,value:i.name}});
  ...
  const handleSubmit = async(e) => {
    ...
    await axios.post('/api/manufacture/create_manufacturing_order', {...formData,manufactureMonth:months[formData.manufactureMonth-1]}, {
    ...
    console.log(storeId);
   console.log('Manufacturing Order Data:', formData);
...
export default PlaceManufactureOrder;
